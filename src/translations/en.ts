export default {
	...
	"keys": {
		...
		"imapImportStartedExplanation_msg": "Usually importing IMAP emails is really fast. Though, large imports can take several days. We will notify you when your import is finished.",
